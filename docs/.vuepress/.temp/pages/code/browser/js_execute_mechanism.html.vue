<template><div><h2 id="变量提升-javascript-代码是按顺序执行的吗" tabindex="-1"><a class="header-anchor" href="#变量提升-javascript-代码是按顺序执行的吗" aria-hidden="true">#</a> 变量提升：JavaScript 代码是按顺序执行的吗？</h2>
<p>只有理解了 JavaScrip 的执行上下文，你才能更好地理解 JavaScript 语言本身</p>
